...
describe("WorkspacesPage", () => {
  ...
  it("renders loading state", () => {
    ...
    render(<WorkspacesPage params={{ id: "wf-1" }} />);
  ...
  it("renders empty state when no workspaces spawned", () => {
    mockUseWorkflow.mockReturnValue({
  ...
  it("shows leak alert when spawns != destroys", () => {
    mockUseWorkflow.mockReturnValue({
      data: { id: "wf-1", name: "Test Workflow", status: "running" },
      isLoading: false,
      error: null,
  ...
  it("does not show leak alert when spawns == destroys", () => {
    mockUseWorkflow.mockReturnValue({
  ...
  it("renders lifecycle table with spawn and destroy rows", () => {
    mockUseWorkflow.mockReturnValue({
      data: { id: "wf-1", name: "Test Workflow", status: "completed" },
      isLoading: false,
      error: null,
  ...
  it("renders workspace chart with concurrency data", () => {
    mockUseWorkflow.mockReturnValue({
      data: { id: "wf-1", name: "Test Workflow", status: "completed" },
      isLoading: false,
      error: null,
  ...
  it("shows KPI strip with correct values", () => {
    mockUseWorkflow.mockReturnValue({
      data: { id: "wf-1", name: "Test Workflow", status: "running" },
      isLoading: false,
      error: null,
